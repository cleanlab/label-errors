...
Download the QuickDraw dataset here: https://github.com/cgnorthcutt/label-errors/releases/tag/quickdraw-pyx-v1

Use cleanlab to find label errors in the dataset: https://github.com/cgnorthcutt/cleanlab
